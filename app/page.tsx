  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex flex-col text-white">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 z-50 bg-blue-900 bg-opacity-95 backdrop-blur-sm">
            <div className="px-4 py-6 space-y-4">
              <button
                ...
                className="block w-full text-left text-white hover:text-yellow-300 transition-colors font-medium py-2"
              >
                Beranda
              </button>
              <button
              ...
              <button
                onClick={() => {
                  scrollToSection('hubungi-section');
                  closeMobileMenu();
                }}
                className="block w-full text-left text-white hover:text-yellow-300 transition-colors font-medium py-2 flex items-center"
              >
        ...
        <div style={{ backgroundColor: '#00052d' }} className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              {/* Cards Container */}
              <div className="flex justify-center items-center space-x-8 px-4 sm:px-16 overflow-hidden max-w-full">
